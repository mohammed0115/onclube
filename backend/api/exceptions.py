...
CODE_STATUS = {
    ...
    "invalid_status": http_status.HTTP_422_UNPROCESSABLE_ENTITY,
    "cannot_change_self": http_status.HTTP_422_UNPROCESSABLE_ENTITY,
    "user_not_found": http_status.HTTP_404_NOT_FOUND,
