...
const AREAS = [
  { icon: Activity, label: "Operations", desc: "Payments, sessions & alerts", tone: "text-indigo-600 bg-indigo-50", to: "/admin/sessions" },
  { icon: GraduationCap, label: "Academics", desc: "Students, teachers & content", tone: "text-purple-600 bg-purple-50", to: "/admin/members" },
  { icon: BarChart3, label: "Business", desc: "Subscriptions, revenue & plans", tone: "text-emerald-600 bg-emerald-50", to: "/admin/business" },
  { icon: Server, label: "Platform", desc: "Providers, health & jobs", tone: "text-sky-600 bg-sky-50", to: "/admin/platform" },
